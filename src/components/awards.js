...
function Awards() {
  const data = [
    ...
    { id: 3, description: "DNA Paris Design Winner Award of 2022", image: "https://terralogic.com/wp-content/uploads/2022/09/DNA-award-1.png", byText: "BY DNA PARIS DESIGN" },
